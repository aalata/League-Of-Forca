...
import com.example.tallessiqueira.leagueofforca.util.SystemUiHider;
    ...
    **/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                scoreDao = ScoreDao.getInstance(getApplicationContext());
                Intent chamaMenu = new Intent(Inicio.this, menuForca.class);
